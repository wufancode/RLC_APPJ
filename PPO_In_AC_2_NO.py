...
Target_UPDATE_TIMES = 30
ACTOR_UPDATE_TIMES = 15
CRITIC_UPDATE_TIMES = 30
FC1_n = 256
FC2_n = 128
Critic_LR = 2e-4
Actor_LR = 1e-4
MODEL_NAME = 'model-2factors-NO'
test = np.array([1.5])
...
def main():
    ...
    target = np.random.uniform(0.15, 0.8, (ROLL_STEPS, 1))
    if train == 1:
