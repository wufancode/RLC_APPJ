...
if sel == 1:
    ...
    mid_path = 'DDPG_TF2-main/DNN/Train_NO/'
    model_path = 'DDPG_TF2-main/DNN/DNN_Model_NO_2'
    label_name = 'NO'
    para = [420, 200, 90]
    lr_rate = 0.001
elif sel == 2:
    data_path = './Data_O.csv'
    mid_path = 'DDPG_TF2-main/DNN/Train_O/'
    model_path = 'DDPG_TF2-main/DNN/DNN_Model_O_2'
    label_name = 'O'
    para = [256, 100, 80]
    lr_rate = 0.001
...
print("Testing set mse:", mean_squared_error(test_labels, test_predictions)*(y_max-y_min) ** 2,
      "Testing set mae:", mean_absolute_error(test_labels, test_predictions)*(y_max-y_min),
